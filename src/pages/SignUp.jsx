...
const SignUp = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Perform your form submission logic here, after email verification
            ...
            <div className="form">
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-group m-3">
                  ...
                  <input type="email" class="form-control" id="email" placeholder="Email id" value={email} onChange={(e) => setEmail(e.target.value)} required />
                </div>
                ...
                <button className="btn btn-success rounded-3 mt-3  py-2 px-4" type="submit"> Sign Up </button>
                </div>
              </form>
