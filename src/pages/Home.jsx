                ...
                <div className="row">
                    <div className="col-md-5">
                        <img
                            ...
                            data-qa="hero-image-desktop"
                            className="cld-responsive d-none d-md-block img-fluid"
                            data-v-3fa42971=""
                        />
                    </div>
                    <div className="col-md-7 px-lg-2">
                        <h1 className="card-titles">Up your work game, it’s easy</h1>
                        <ul className="list-unstyled">
                            <li><strong>No cost to join</strong></li>
                            <li><strong>Register and browse professionals, explore projects, or even book a consultation.</strong></li>
                            <li><strong>Post a job and hire top talent. Finding talent doesn’t have to be a chore. Post a job or we can search for you!</strong></li>
                            <li><strong>Work with the best—without breaking the bank. Upwork makes it affordable to up your work and take advantage of low transaction rates.</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
