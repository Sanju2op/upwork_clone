...
const FreelancerProposalDetails = ({ proposalData, Back }) => {
    if (!proposalData || !proposalData.jobId || !proposalData.jobId.userId) {
        return <div>Client deleted job data
        ...
        <div className="container">
            ...
            <div className="card">
                ...
                <div className="card-body">
                    <span className="badge bg-secondary m-2">{proposalData.jobId.category}</span>
                    <span className="badge bg-secondary">{proposalData.jobId.subcategory}</span>
